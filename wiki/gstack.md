...
| 2026-05-12 | raw/2026-04-18-garry-tan-loc-controversy.md | Snapshot of production usage at Apr 18: 75K stars, 14,965 unique installs, 305,309 skill invocations, 95.2% success rate, ~7K WAU; `/qa` is 2,000+ lines real Playwright code (server + CDP + snapshot engine); GBrowser teaser (compiled Chromium with Claude Code sidebar) |
