...
tags: [wiki, product, platform, ai-assistant]
---

# OpenClaw

## Summary
Platform for building AI assistants that unlocked capabilities previously impossible with raw AI APIs. Used by [[ryan-sarver|Ryan Sarver]] to build "Stella," a chief-of-staff-level AI assistant managing fundraising, meeting prep, task management, and relationship tracking. Also used by [[garry-tan|Garry Tan]] (YC CEO), who has codified usage rules from his instance into widely-shared discipline.
...
## Connections
- Related: [[ryan-sarver]], [[garry-tan]], [[kaizen-loop]], [[thin-harness-fat-skills]], [[skill-as-method-call]], [[llm-judgment-vs-scripts]]
