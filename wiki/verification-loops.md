...
| 2026-05-16 | raw/2026-03-19-tw93-agent-architecture-and-engineering.md | Added "the eval system itself can be the bug" framing — see [[agent-evaluation-traps]] for the full taxonomy. Transcript vs outcome distinction: Anthropic's airline-booking example where Opus 4.5 found a policy loophole → transcript-eval marked failure, outcome-eval recognized strictly-better result. Don't tweak the Agent before checking your eval infrastructure |
| 2026-05-16 | raw/2026-05-11-openai-cookbook-build-iterative-repair-loops.md | Cross-linked [[iterative-repair-loop]] — the Review→Repair→Validate pattern is the official OpenAI version of the verification-loops primitive for closed-loop artifact repair |
| 2026-05-16 | raw/2026-05-12-openai-cookbook-agent-improvement-loop.md | Cross-linked [[agent-improvement-flywheel]] — the per-system-version analogue to verification-loops |
