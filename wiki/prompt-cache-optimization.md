...
| 2026-05-16 | raw/2026-03-19-tw93-agent-architecture-and-engineering.md | Added Tw93's counter-intuitive principle: **a stable large system prompt costs less than a frequently-varying small one** — because the large prompt pays its write cost once and then earns the ~90% read discount on every subsequent call. The "short system prompt" intuition is wrong; the real metric is *stability*. Also: Skills lazy-loading **protects** cache by appending to the stable prefix instead of mutating it |
