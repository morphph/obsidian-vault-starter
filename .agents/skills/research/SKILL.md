...
Read AGENTS.md first for wiki conventions. This skill produces research artifacts in a
...
- **Headless rule（被 headless Codex / driver 调起时）**: there is no one to answer a pause —
