...
**Docs drift (schema mirrors):** AGENTS.md is the source of truth; README.md must mirror it (per `feedback_readme_as_hub`). Check:
- AGENTS.md Commands table vs actual files: every row has a matching `.Codex/commands/{name}.md` or `.Codex/skills/{name}/SKILL.md`, and every file has a row
- AGENTS.md Skills table vs actually-available skills (local folders + installed plugins)
- README.md Commands table + Vault Structure section vs AGENTS.md and vs actual directories
...
- Sync AGENTS.md/README.md tables, counts, and structure listings to reality (docs drift)
