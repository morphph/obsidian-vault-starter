...
**Source URL:** https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything
**Author:** Thariq Shihipar — Member of Technical Staff on the Claude Code Team @ Anthropic
**Posted:** 2026-04-30
**Reading Time:** 5 minutes
**Format:** Anthropic engineering blog post
**Fetch method:** WebFetch (static content, worked first try)

---

## Article: Lessons from Building Claude Code — Prompt Caching is Everything
...
The same principle applies to the tool search tool. Claude Code can have dozens of MCP tools loaded, and including all of them in every request would be expensive, but removing them mid-conversation would break the cache.
