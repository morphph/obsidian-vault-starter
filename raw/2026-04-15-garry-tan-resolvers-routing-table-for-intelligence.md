...
**Author:** Garry Tan (@garrytan, President & CEO @ycombinator)
**Posted:** 2026-04-15 18:14 UTC
**Engagement (at fetch time):** 47 replies · 156 reposts · 1,159 likes · 3,211 bookmarks · 293K views
**Fetch method:** Playwright MCP (x.com is JS-heavy; WebFetch gates)
**Context:** Follow-up to "Thin Harness, Fat Skills" (2026-04-11). The prior article introduced five primitives; this one zooms fully into **resolvers**, which got the least attention but which Garry argues matter most.
