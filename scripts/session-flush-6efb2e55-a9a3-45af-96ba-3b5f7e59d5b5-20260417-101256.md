**Assistant:** # Opus 4.7 登场，OpenAI 转攻生物科技，一个笔记本模型把它俩都打了

**2026 年 4 月 17 日**

今天的 AI 圈剧本比电影还精彩 — **Anthropic** 发了新旗舰 **Opus 4.7**，**OpenAI** 掏出了专攻生物的 **GPT Rosalind**，结果阿里的 **Qwen3.6** 用 3B 激活参数在笔记本上把两家都比下去了。大厂卷生卷死，开源笑到了最后。

今天聊：Opus 4.7 的 Agent 飞跃、OpenAI 的生物学豪赌、以及一个开源笔记本模型为什么能越级挑战。
