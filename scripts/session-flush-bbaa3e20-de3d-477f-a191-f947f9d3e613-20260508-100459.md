**Assistant:** # Claude Invades Microsoft Office, OpenAI Ships Voice Agents, and Anthropic Cracks Open the Black Box

**2026-05-08**

Anthropic just put Claude inside the apps where a billion knowledge workers actually live — Excel, PowerPoint, Word, and Outlook. Meanwhile, OpenAI dropped GPT-5-class reasoning into voice agents, and Anthropic published research that lets you read what Claude is actually thinking. The enterprise AI war moved from the API to the toolbar today.

Today: Claude's Microsoft Office takeover, GPT-5-class voice agents in the API, and reading what models actually think.
